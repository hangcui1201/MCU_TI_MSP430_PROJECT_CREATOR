...
class CreateProjectG2553():
	...
	def copy_project_files(self):
	    ...
	    src_dir = os.path.dirname(__file__) + '/' + '../' + "/DefaultProjects/G2553DefaultProject" 
	    src_dir = os.path.abspath(src_dir)

	    ccsproject_path = src_dir + "\\Project\\.ccsproject"
	    lnk_msp430g2553_path = src_dir + "\\Project\\lnk_msp430g2553.cmd"
	    MSP430G2553_path = src_dir + "\\Project\\MSP430G2553.ccxml"
	...
	def create_project_files(self):
	    ...
	    project_file_path = src_dir + "\\Project\\.project"
	    ...
	    cproject_path = src_dir + "\\Project\\.cproject"
